...
class Section3:
    ...
    def partC(
       ...
       # X, y, Xtest, ytest = u.prepare_data()
        ...
        # Enter your code and fill the `answer` dictionary
        answer = {}
        answer["scores"] = {'mean_accuracy' : 0.991399416909621, 'mean_recall' : 0.9610675555138256, 'mean_precision' : 0.9842783011442116, 'mean_f1' : 0.9721517857250799, 'std_accuracy' : 0.0016874397817478592, 'std_recall' : 0.011449940491256092, 'std_precison' : 0.00779698019475328, 'std_f1' : 0.005591841444297839}
    ...
    def partD(
       ...
       # X, y, Xtest, ytest = u.prepare_data()
        ...
        answer["scores"] = {'mean_accuracy' : 0.9897959183673469, 'mean_recall' : 0.9769212713018168, 'mean_precision' : 0.9606758953497522, 'mean_f1' : 0.9684275839262299, 'std_accuracy' : 0.0028039918457246765, 'std_recall' : 0.009824197849573576, 'std_precison' : 0.013480770822895392, 'std_f1' : 0.008457932563265994}
        answer["cv"] = StratifiedKFold(n_splits=5, shuffle=True, random_state=42)
        answer["clf"] = SVC(random_state=42)
